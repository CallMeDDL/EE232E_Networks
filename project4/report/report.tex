...
We chose community(ID=24) who includes 12 movies to further study the correlation among actors, movies and genres. Table \ref{table_2_3} shows the basic informaiton of this community, while Table \ref{table_2_4} and Table \ref{table_2_4} list the ID and Name mapping correlation in movies and actors respectively.
...
\begin{figure}[H]
\centering
\scalebox{0.7}{\includegraphics{Figures/community_1.png}}
...
\begin{figure}[H]
\centering
\scalebox{0.7}{\includegraphics{Figures/community_2.png}}
...
\begin{figure}[H]
\centering
\scalebox{0.7}{\includegraphics{Figures/community_28.png}}
...
\begin{figure}[H]
\centering
\scalebox{0.6}{\includegraphics{Figures/community_24.png}}
...
\begin{figure}[H]
\centering
\scalebox{0.6}{\includegraphics{Figures/community_25.png}}
