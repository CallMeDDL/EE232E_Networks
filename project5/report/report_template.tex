...
\textcolor{red}{Question 1: Provide an upper and lower bound on $\rho_{ij}$. Also, provide a justification for using log-normalized return $r_i(t)$ instead of regular return $q_i(t)$.}
...
\begin{displaymath}r_i(1) + r_i(2) + r_i(3) + ... + r_i(n) =logp_i(n) - logp_i(0)\end{displaymath}
...
\textcolor{red}{Question 2: Plot the degree distribution of the correlation graph and a histogram showing the un-normalized distribution of edge weights.}
