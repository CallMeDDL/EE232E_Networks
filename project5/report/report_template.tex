...
=======
\scalebox{0.8}{\includegraphics{Figures/triangulation.png}}
\caption{Road mesh after Delaunay triangulation}
>>>>>>> eab067672bafafc04f3315fe8f01bef86c25fbe4
\label{fig:road_mesh}
\end{figure}
...
What's more, for those real bridges like Golden Gate Bridge, Richmond, San Rafael Bridge, San Mateo Bridge, Dambarton Bridge and San Francisco - Oakland Bay Bridge, which is shown in the red color in the Fig. \ref{3_2}, we can observe from the graph after trimming that those bridges are still included in the new map but some other fake bridges have gone. \\
